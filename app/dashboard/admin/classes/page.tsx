...
import { Plus, Search, Download, Filter, Edit, Trash2, Eye, BookOpen, Users, GraduationCap } from "lucide-react"
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input placeholder="Search classes by name, teacher, or ID..." className="pl-10" />
              </div>
              <Button variant="outline">
