...
import { LogOut, LayoutDashboard, BookOpen, Users, ClipboardCheck, FileText, Calendar, User, Wallet, ChevronLeft, ChevronRight, GraduationCap, Bell, MessageCircle, FolderOpen } from "lucide-react"
...
const menuItems = [
  ...
  { name: "Assessment", href: "/dashboard/teacher/assessment", icon: FileText },
  ...
  { name: "Materials", href: "/dashboard/teacher/materials", icon: FolderOpen },
...
const bottomMenuItems = [
  ...
  { name: "Payroll", href: "/dashboard/teacher/payroll", icon: Wallet },
]
    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center gap-3 px-6 py-5 border-b border-sidebar-border ${collapsed ? "justify-center px-4" : ""}`}>
          ...
          {!collapsed && (
            <span className="text-xl font-bold text-foreground">TeachPro</span>
          )}
        </div>
        ...
        {/* Bottom Navigation - Profile & Payroll */}
        ...
        <div className={`px-4 py-4 border-t border-sidebar-border ${collapsed ? "px-2" : ""}`}>
          {collapsed ? (
            <Avatar className="w-10 h-10 mx-auto cursor-pointer" title="Prof. Sarah Anderson">
            ...
            <div className="flex items-center gap-3 px-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">Prof. Sarah Anderson</p>
